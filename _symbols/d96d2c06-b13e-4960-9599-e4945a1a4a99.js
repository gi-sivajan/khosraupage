// Site Footer - Updated October 1, 2023
function noop() { }
...
function create_fragment(ctx) {
	...
	return {
		c() {
			...
			span = element("span");
			p = element("p");
			t1 = text("This site is intentionally CSS minimal.");
			t2 = space();
			div = element("div");
		...
		l(nodes) {
			...
			p = claim_element(span_nodes, "P", {});
			var p_nodes = children(p);
			t1 = claim_text(p_nodes, "This site is intentionally CSS minimal.");
