// Accordion - Updated October 1, 2023
function noop() { }
const identity = x => x;
...
function create_if_block(ctx) {
	...
	return {
		...
		h() {
			attr(div, "class", "description svelte-7gtufw");
		},
		m(target, anchor) {
...
function create_each_block(key_1, ctx) {
	...
	return {
		...
		h() {
			attr(span0, "class", "svelte-7gtufw");
			attr(span1, "class", "icon svelte-7gtufw");
			attr(button, "class", "svelte-7gtufw");
			attr(div1, "class", "item svelte-7gtufw");
...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			attr(h2, "class", "heading svelte-7gtufw");
			attr(div, "class", "accordion svelte-7gtufw");
			attr(section, "class", "section-container svelte-7gtufw");
		},
		m(target, anchor) {
